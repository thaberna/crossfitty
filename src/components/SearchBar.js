...
export default function SearchBar() {
  ...
  return (
    <>
      ...
      {wods.length > 0 ? (
        <div className="relative w-full md:max-w-lg px-4 mt-2 rounded-lg overflow-auto h-48 bg-[#11162A]">
          {wods.map((wod) => (
            <Link
              key={wod.id}
        ...
        <div className="relative w-full md:max-w-lg p-4 mt-2 overflow-auto rounded-lg bg-[#11162A]">
